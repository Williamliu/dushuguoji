	...
	<div class="panel panel-default z-depth-2">
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="view">
						<img class="img-thumbnail img-fluid" src="theme/light/company/subject03.jpg" />
						<div class="mask flex-center">
				...
				<div class="col-md-4">
					<div class="view">
						<img class="img-thumbnail img-fluid" src="theme/light/company/subject04.jpg" />
						<div class="mask flex-center">
				...
				<div class="single-news">
					<div class="row">
						<div class="col-md-3">
							<!--Image-->
 							<div class="avatar">
                        		<img src="theme/light/student/wang.jpg" class="img-circle img-fluid">
                    		</div>
						</div>
				...
				<div class="single-news">
					<div class="row">
						<div class="col-md-3">
							<!--Image-->
 							<div class="avatar">
                        		<img src="theme/light/student/li.jpg" class="img-circle img-fluid">
                    		</div>
						</div>
				...
				<div class="single-news">
					<div class="row">
						<div class="col-md-3">
							<!--Image-->
 							<div class="avatar">
                        		<img src="theme/light/student/lu.jpg" width="320" height="240" class="img-circle img-fluid">
                    		</div>
						</div>
